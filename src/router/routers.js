...
const router = new Router({
  routes: [
    ...
    {path: '/user/info/:userId', name: 'userInfo', perm: 'user-info', component: r => require.ensure([], () => r(require('../components/user/userInfo.vue')))},
    {path: '/play', name: 'play', perm: 'play-manage', component: r => require.ensure([], () => r(require('../components/message/playpage.vue')))},
    {path: '/test', name: 'socket-info', perm: 'socket-manager', component: r => require.ensure([], () => r(require('../components/message/test-all.vue')))},
    {
      path: '/home',
      ...
      children: [
        {
          ...
          meta: {moduleId: 'account', title: '笔记本', perm: 'system-leave'}
        },
        {
          path: '/account/list',
          component: resolve => require(['../components/account/index.vue'], resolve),
          meta: {moduleId: 'account', title: '记事本', perm: 'account-list'}
        }
      ]
    },
    {
